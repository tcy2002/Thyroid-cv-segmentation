...
from seg_hw.growth.growth import *
from seg_hw.unet.processor import *
from seg_hw.watershed.watershed import *
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # 2.1 设置分割方法
        self.set_method_menu = self.edit_menu.addMenu("甲状腺分割方法")
        # 2.1.1 区域生长
    ...
    def slot_help(self):
        QMessageBox.information(self, "操作说明", "主菜单说明：\n"
                                              ...
                                              "11.当选取的种子点数目较多时，处理时间可能较长，请勿离开或关闭窗口\n", QMessageBox.Ok)
